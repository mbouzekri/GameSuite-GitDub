...
public class Checkers{
    ...
    /**
     * method to switch to lobby of checkers game
     * @param event
     * @throws IOException
     */
    ...
    /**
     * method to show instructions of checkers game
     * @param event
     * @throws IOException
     */
    public void showInstructions(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("CheckersInstructions.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    private class CheckersBoard extends Canvas {
         ...
         */
        CheckersBoard() {
            super(500, 500);  // canvas is 324-by-324 pixels
        ...
        public void drawBoard() {
            ...
            for (int row = 0; row < 8; row++) {
                for (int col = 0; col < 8; col++) {
                    if ( row % 2 == col % 2 )
                        g.setFill(Color.rgb(188, 167, 202));
                    else
                        g.setFill(Color.rgb(57, 41, 78));
                    g.fillRect(2 + col*62.5, 2 + row * 62.5, 62.5, 62.5);
                    switch (board.pieceAt(row,col)) {
                    case CheckersData.RED:
                        g.setFill(Color.rgb(141, 60, 153));
                        g.fillOval(8 + col*62.5, 8 + row*62.5, 50, 50);
                        break;
                    case CheckersData.BLACK:
                        g.setFill(Color.rgb(27, 22, 44));
                        g.fillOval(8 + col*62.5, 8 + row*62.5, 50, 50);
                        break;
                    case CheckersData.RED_KING:
                        ...
                        g.fillText("K", 26 + col*62.5, 41 + row*62.5);
                        break;
            ...
            if (gameInProgress) {
                ...
                g.setStroke(Color.rgb(235, 96, 238));
                g.setLineWidth(4);
                for (int i = 0; i < legalMoves.length; i++) {
                    g.strokeRect(4 + legalMoves[i].fromCol*62.5, 4 + legalMoves[i].fromRow*62.5, 58.5, 58.5);
                }
                ...
                if (selectedRow >= 0) {
                    ...
                    g.setLineWidth(4);
                    g.strokeRect(4 + selectedCol*62.5, 4 + selectedRow*62.5, 58.5, 58.5);
                    g.setStroke(Color.WHITE);
                    g.setLineWidth(4);
                    for (int i = 0; i < legalMoves.length; i++) {
                        if (legalMoves[i].fromCol == selectedCol && legalMoves[i].fromRow == selectedRow) {
                            g.strokeRect(4 + legalMoves[i].toCol*62.5, 4 + legalMoves[i].toRow*62.5, 58.5, 58.5);
                        }
                    }
                }
            }
        ...
        public void mousePressed(MouseEvent evt) {
            if (gameInProgress == false)
                ...
                int col = (int)((evt.getX() - 2) / 62.5);
                int row = (int)((evt.getY() - 2) / 62.5);
